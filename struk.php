...
?>
    ...
    <body onload="print()">
        ...
        <div class="jumbotron jumbotron-fluid text-center">
            <div class="container">
                <h1 class="display-4"><span class="font-weight-bold text-dark">Restoran Web</span></h1>
                <p class="text-center text-dark">Jl. Kasuari 2 Raya, Bekasi Timur</p>
                <hr>
                <!-- <p class="lead font-weight-bold text-dark">Silahkan Pesan Menu Sesuai Keinginan Anda <br> 
          Enjoy Your Meal</p> -->
            </div>
        </div>
        <!-- Akhir Jumbotron -->
        ...
        <!-- Menu -->
        <div class="container">
            <div class="judul-pesanan" style="margin-top: -15%;">
        ...
        <button class="btn btn-success btn-sm" name="konfirm">Konfirmasi Pesanan</button>
            ...
            if (isset($_POST['konfirm'])) {
              ...
              VALUES ('$id_terbaru', '$id_menu', '$jumlah') ");
                ...
                echo "<script>alert('Apakah Anda Ingin Cetak Struk UwU ??');</script>";
                echo "<script>location= 'menu_pembeli.php'</script>";
            }
            ?>
        </div>

        <div class="d-inline container-cs">
          <div class="" align="left" style="margin-top: 10%;">
              <!-- <center> -->
                  <p style="color: #000">Bekasi, <?= date('d F Y'); ?></p>
                  <p style="margin-top: -10px;">Owner Resto</p>
                  <br>
                  <p style="margin-top: -5px;">Rivo Juniandra</p>
              <!-- </center> -->
          </div>
          <div class="" align="right" style="margin-top: -14%;">
              <!-- <center> -->
                  <p style="color: #000">Bekasi, <?= date('d F Y'); ?></p>
                  <p style="margin-top: -10px;">Kasir Resto</p>
                  <br>
                  <p style="margin-top: -5px;">Kevin Sipahutar</p>
              <!-- </center> -->
          </div>
        </div>
      ...
      $(document).ready(function() {
        ...
        <!-- <script>
            setTimeout(function() {
                window.location.href = "http://localhost/resto/pesanan_pembeli.php?unset";
            }, 1000);
        </script> -->
    </body>
